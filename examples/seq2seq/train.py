...
def main():
    ...
    parser.add_argument("--train_file", default="../data/cn/sighan_2015/train.tsv", type=str, help="Train file")
    parser.add_argument("--test_file", default="../data/cn/sighan_2015/test.tsv", type=str, help="Test file")
    parser.add_argument("--output_dir", default="outputs/sighan_convseq2seq/", type=str, help="Dir for model save.")
    ...
    if args.do_train:
        ...
        model = ConvSeq2SeqModel(epochs=args.num_epochs, batch_size=args.batch_size,
                                 model_dir=args.output_dir, max_length=args.max_length)
